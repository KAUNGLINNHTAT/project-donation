                ...
                <form method="POST" id="form">
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" class="h-4 w-4 checked:bg-indigo-500 checked:border-transparent border border-gray-300"><span class="ml-2 text-sm text-gray-500">{{ __('messages.label.hide_name') }}</span>
                        </label>
                    </div>
                    <div class="mb-6">
